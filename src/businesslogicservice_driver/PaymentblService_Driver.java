...
public class PaymentblService_Driver {
	...
	public void drive(PaymentblService paymentblService){
		boolean result1=paymentblService.createPaymentPO(new PaymentVO(new Long("00021160112000001"),new Date() , 30.00, "zhang", 1000000000000000000L, Entry.AWARDS, "yes"));
		if(result1==true)
			System.out.println("Creat succeed\n");
		
		boolean result2=paymentblService.modifyPaymentPO(new PaymentVO(new Long("00021160112000001"),new Date() , 30.00, "zhang", 1000000000000000000L, Entry.AWARDS, "yes"));
		if(result2==true)
