...
public class StatisticsDialog extends JDialog{
	...
	public StatisticsDialog(JTabbedPane tabbedPane , int i ){
		index = i;
		this.tabbedPane =  tabbedPane;
		int dialogx = 380;
		int dialogy = 240;
	...
	class ConfirmButtonListener1 implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {		
			...
			@SuppressWarnings("unused")
			StatisticsPanel statisticsPanel = new StatisticsPanel(tabbedPane, paymentPanel,revenuePanel, index);
			StatisticsDialog.this.dispose();
		}
	}
