...
public class StoreoutCheckPanel extends JPanel{
    ...
    public StoreoutCheckPanel(List<OutOrderCheckResultVO> dataList){
    	...
    	storeoutTotalLabel = new JLabel("总入库数量");
    	storeoutTotalLabel.setBounds(300, 400, 150, 25);
    	storeoutTotalTextField = new JTextField();
    	storeoutTotalTextField.setBounds(460, 400, 60, 25);
        ...
        storeoutScrollPane.setBounds(0, 40, 560, 370);
