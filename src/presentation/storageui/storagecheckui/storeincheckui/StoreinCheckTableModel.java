...
public class StoreinCheckTableModel extends DefaultTableModel{
	...
	private static final String[] TABLE_HEADER = { "订单号", "入库日期", "目的地", "区号",
			"排号", "架号", "位号", "重量", "体积" };
	...
	private static Vector<Vector<Object>> convertToVectorData(
			List<InOrderCheckResultVO> list) {
